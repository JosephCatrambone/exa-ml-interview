...
class BaseModelMixin(ABC):
    ...
    def embed_document(self, document: str) -> numpy.ndarray:
    ...
    def score_match(self, query_vector: numpy.ndarray, document_vector: numpy.ndarray) -> float:
...
def cosine_similarity(vec1: numpy.ndarray, vec2: numpy.ndarray, assume_normalized: bool = False) -> float:
